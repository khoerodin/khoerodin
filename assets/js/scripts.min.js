...
!function(e){function n(){this===l.elem&&(l.pos=[-260,-260],l.elem=!1,u=3)}var t,i,l={pos:[-260,-260]},u=3,h=document,o=h.documentElement,s=h.body;e.event.special.mwheelIntent={setup:function(){var t=e(this).bind("mousewheel",e.event.special.mwheelIntent.handler);return this!==h&&this!==o&&this!==s&&t.bind("mouseleave",n),t=null,!0},teardown:function(){return e(this).unbind("mousewheel",e.event.special.mwheelIntent.handler).unbind("mouseleave",n),!0},handler:function(n,h){var o=[n.clientX,n.clientY];if(this===l.elem||Math.abs(l.pos[0]-o[0])>u||Math.abs(l.pos[1]-o[1])>u)return l.elem=this,l.pos=o,u=250,clearTimeout(i),i=setTimeout(function(){u=10},200),clearTimeout(t),t=setTimeout(function(){u=3},1500),n=e.extend({},n,{type:"mwheelIntent"}),(e.event.dispatch||e.event.handle).apply(this,arguments)}},e.fn.extend({mwheelIntent:function(e){return e?this.bind("mwheelIntent",e):this.trigger("mwheelIntent")},unmwheelIntent:function(e){return this.unbind("mwheelIntent",e)}}),e(function(){s=h.body,e(h).bind("mwheelIntent.mwheelIntentDefault",e.noop)})}(jQuery);
...
jQuery(function(e){if(hljs.initHighlightingOnLoad(),hljs.initLineNumbersOnLoad(),e(window).width()<600&&e(".page-link").removeClass("button"),e(document).ready(function(){e(".post").fitVids(),e(".episodes").length&&e(function(){e(".episodes").jScrollPane()})}),e(".episodes").length&&e(".series-wrapper").length){var s=e(window).height()-250,i=e(".series-wrapper").height();e(".episodes").css("max-height",s),e(".episodes").css("overflow-x","auto");var t=e(".episodes").height();e(window).scroll(function(){var a=window.pageYOffset,d=window.innerHeight,o=document.body.offsetHeight,r=Math.max(o-(a+d),0),n=e(window).width()-(e(".sidebar").offset().left+e(".sidebar").outerWidth());r<17&&t>=s&&i>s?(e(".sidebar").removeClass("sticked-sidebar"),e(".sidebar").css("right",""),e(".sidebar").addClass("release-sidebar")):(e(".sidebar").removeClass("release-sidebar"),e(this).scrollTop()>50?(e(".sidebar").addClass("sticked-sidebar"),e(".sidebar").css("right",n+"px")):(e(".sidebar").removeClass("sticked-sidebar"),e(".sidebar").css("right","")))})}e(document).ready(function(){e(".page-content").each(function(){var s=e(this).html(),i=emojione.shortnameToImage(s);e(this).html(i)})})});
...
!function(){function t(t,e){var o=document.getElementById("search-results");if(t.length){for(var n="",r=0;r<t.length;r++){var i=e[t[r].ref];n+='<div><h4 style="margin-bottom:auto;"><a href="'+i.url+'">'+i.title+"</a></h4>",n+="<p>"+i.content.substring(0,200)+"...</p></div>"}o.innerHTML=n}else o.innerHTML="No results found"}function e(t){for(var e=window.location.search.substring(1),o=e.split("&"),n=0;n<o.length;n++){var r=o[n].split("=");if(r[0]===t)return decodeURIComponent(r[1].replace(/\+/g,"%20"))}}var o=e("q");if(o){document.getElementById("search-box").setAttribute("value",o);var n=lunr(function(){this.field("id"),this.field("title",{boost:10}),this.field("author"),this.field("category"),this.field("content")});for(var r in window.store){n.add({id:r,title:window.store[r].title,author:window.store[r].author,category:window.store[r].category,content:window.store[r].content});var i=n.search(o);t(i,window.store)}}}();